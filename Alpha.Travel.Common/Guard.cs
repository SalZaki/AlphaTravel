namespace Alpha.Travel.Common
{
    ...
    public class Guard
    {
        ...
        public static bool ArgumentNotNullOrEmptyString(string argumentValue, string argumentName)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "StringCannotBeEmpty", new object[]
                {
                    argumentName
                }));
            }
        ...
        public static void ArgumentNotGreaterThan(double argumentValue, double ceilingValue, string argumentName)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(argumentName, argumentValue, string.Format(CultureInfo.CurrentCulture, "ArgumentCannotBeGreaterThanBaseline", new object[]
                {
                    argumentName,
                    ceilingValue
                }));
